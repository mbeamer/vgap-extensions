...
<button id='TMWizAddMethodBtn'>Create Taxation Method</button><br /> \
        ...
        getTaxNat: function(planet,taxmodel) {
            ...
            if (debug) console.log("Native Tax rate determined: " + rate);
            ...
            if (mc > maxmc) {
			    ...
			    if (debug) console.log("Capped rate: " + rate);
                if (debug) console.log("truncate(maxmc / (nativegvt*20/100*nativeclans/10000)");
			    if (debug) console.log("truncate(" + maxmc +" / (" + planet.nativegovernment + " * 20/100* " +planet.nativeclans + "/10000)");
                if (planet.nativetype == 6)
                    rate = Math.truncate((maxmc/2) / (planet.nativegovernment * 20 / 100 * planet.nativeclans / 1000));
				
				// Exception to the rule is small populations.  Collect _some_ tax
			    if (rate == 0) rate++;
        ...
        getSuggestedNativeRate: function(planet) {
            ...
            var dpi = 102;
            console.log("Looking for Native Rate for planet: " + planet);
